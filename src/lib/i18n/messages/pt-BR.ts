...
export const ptBR: Record<MessageKey, string> = {
  ...
  'mesh.redeemPlaceholder': 'Cole um link de convite',
  ...
  'mesh.permissionPreset.viewOnly': 'Somente leitura (read)',
  'mesh.permissionPreset.reviewer': 'Revisor (read, export)',
  'mesh.permissionPreset.collaborator': 'Colaborador (read, write)',
