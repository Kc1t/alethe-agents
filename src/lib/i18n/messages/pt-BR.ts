...
export const ptBR: Record<MessageKey, string> = {
  ...
  'chat.e2eBadge': 'Criptografado ponta a ponta',
  ...
  'chat.localOnlyNotice':
    'As mensagens hoje sincronizam só neste dispositivo — a entrega remota ainda não foi implementada.',
  ...
  'collaboration.recommendedBadge': 'Recomendado',
  ...
  'collaboration.mode.alethe_managed.description':
    'Funciona automaticamente usando o servidor oficial do Alethe. Não precisa configurar nada — só clique em "Ativar colaboração" abaixo.',
  'collaboration.mode.advanced_custom.title': 'Servidor próprio',
  'collaboration.mode.advanced_custom.description':
    'Para usuários avançados: aponte o Alethe para um servidor compatível que você mesmo hospeda e controla.',
  ...
  'p2pTest.title': 'Teste de conexão P2P com um amigo',
  'p2pTest.description':
    'Fluxo manual pra validar convite remoto e conexão direta (P2P) entre duas contas diferentes em redes diferentes. Cada passo mostra o que fazer — combine os campos marcados com o seu amigo por fora (chat, etc.).',
  'p2pTest.step1': '1. Gere seu código de pareamento e mande pro seu amigo',
  'p2pTest.generateCode': 'Gerar meu código',
  'p2pTest.copy': 'Copiar',
  'p2pTest.step2': '2. Cole o código que seu amigo te mandou',
  'p2pTest.pasteFriendCode': 'Cole aqui o código do amigo…',
  'p2pTest.verify': 'Verificar',
  'p2pTest.friendVerified': 'Dispositivo do amigo verificado: {device}',
  'p2pTest.step3': '3. Conecte no Cloudflare (o mesmo Worker que os dois configuraram)',
  'p2pTest.connect': 'Conectar',
  'p2pTest.connected': 'Conectado',
  'p2pTest.step4': '4. Envie um convite de teste pro projeto ativo',
  'p2pTest.invitationIdLabel': 'ID do convite (combine com o amigo)',
  'p2pTest.sendInvite': 'Enviar convite',
  'p2pTest.step5': '5. Combine um ID de sessão e troquem os candidatos de conexão',
  'p2pTest.sessionIdLabel': 'ID da sessão P2P (qualquer texto, os dois digitam o mesmo)',
  'p2pTest.shareCandidate': 'Descobrir e enviar meu endereço',
  'p2pTest.checkIncoming': 'Verificar entregas do Cloudflare',
  'p2pTest.myCandidate': 'Meu endereço público: {addr}',
  'p2pTest.friendCandidate': 'Endereço do amigo recebido: {addr}',
  'p2pTest.step6':
    '6. Tente a conexão direta — só um lado clica "Iniciador", o outro "Respondedor"',
  'p2pTest.connectAsInitiator': 'Conectar como iniciador',
  'p2pTest.connectAsResponder': 'Conectar como respondedor',
  'p2pTest.initiatorHint':
    'Combinem por fora quem clica em qual — os dois lados tentando o mesmo papel ao mesmo tempo trava o handshake.',
  'p2pTest.p2pSuccess': 'Conexão P2P direta estabelecida com o dispositivo {device}!',
  'p2pTest.logEmpty': 'Nenhuma ação ainda.',
