...
export const ptBR: Record<MessageKey, string> = {
  ...
  'prefs.multiagentPluginsTitle': 'Gerenciador de plugins',
  'prefs.multiagentPluginsDesc':
    'Veja e instale plugins do orquestrador e ferramentas customizadas.',
  'prefs.multiagentPluginInstallLabel': 'Instalar plugin (manifesto JSON)',
  'prefs.multiagentPluginInstallPlaceholder': 'Cole aqui o JSON do manifesto do plugin...',
  'prefs.multiagentPluginInstallButton': 'Instalar plugin',
  'prefs.multiagentPluginInstallInvalid': 'Manifesto inválido. Preencha name, version e kind.',
  'prefs.multiagentPluginInstallSuccess': 'Plugin instalado com sucesso.',
  'prefs.multiagentPluginInstallError': 'Falha ao instalar plugin: {error}',
  'prefs.multiagentPluginUninstall': 'Desinstalar',
  'prefs.multiagentPluginUninstallConfirm': 'Tem certeza que deseja desinstalar o plugin "{name}"?',
  'prefs.multiagentPluginUninstallSuccess': 'Plugin desinstalado.',
  'prefs.multiagentPluginUninstallError': 'Falha ao desinstalar plugin: {error}',
  'prefs.multiagentPluginKind': 'Tipo: {kind}',
  'prefs.multiagentPluginBundled': 'Integrado',
  'prefs.multiagentPluginEnabled': 'Ativado',
  'prefs.multiagentPluginError': 'Falha ao ativar: {error}',
  'prefs.multiagentNoPlugins': 'Nenhum plugin instalado no momento.',
