...
export const ptBR: Record<MessageKey, string> = {
  ...
  'whatsNew.v150.note1': 'O onboarding não trava mais ao detectar CLIs instalados; cada verificação agora tem um limite de tempo.',
  'whatsNew.v150.note2': 'A troca de conta e perfil agora termina de forma confiável sem reiniciar o app, incluindo a retomada de terminais pausados.',
  'whatsNew.v150.note3': 'Nova ação "Apagar todos os dados (instalação limpa)" redefine todos os perfis, projetos e ajustes depois que você exportar um backup.',
  'whatsNew.v150.note4': 'A exportação de perfil agora inclui todos os dados do perfil, como Todos, histórico, preferências, tokens e scrollback dos terminais.',
  'whatsNew.v150.note5': 'O controle remoto pela LAN permite navegar pelos chats dos agentes, acompanhar a saída dos terminais e enviar mensagens por uma página móvel autenticada.',
  'whatsNew.v150.note6': 'Escolha o ícone nativo do desktop independentemente do tema do app, com todos os temas do Alethe e as duas variantes em degradê.',
  'whatsNew.v150.note7': 'Os seletores de projeto agora permanecem dentro da tela, truncam caminhos longos e respondem ao Escape de forma consistente.',
  'whatsNew.v150.note8': 'A retomada do Codex impede que dois terminais assumam a mesma conversa e se recupera corretamente de erros de escritor ativo.',
