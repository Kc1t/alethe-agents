...
export const ptBR: Record<MessageKey, string> = {
  ...
  'collaborationView.chatTab': 'Chat',
  'collaborationView.tasksTab': 'Tarefas',
  'collaborationView.vaultTab': 'Cofre & Pastas',
  'collaborationView.noProject': 'Abra ou selecione um projeto para usar a colaboração.',
  'collaborationView.comingSoon': 'Em breve.',
  'chat.channelTitle': 'Canal do projeto',
  'chat.empty': 'Nenhuma mensagem ainda — diga oi.',
  'chat.loadFailed': 'Não foi possível carregar ou enviar mensagens.',
  'chat.connectionState.local': 'Somente local',
  ...
  'chat.syncNotice.p2p': 'Conectado direto com o outro dispositivo — as mensagens chegam na hora.',
  'chat.syncNotice.relay':
    'Sem conexão direta ainda — as mensagens estão sendo entregues pelo seu Worker Cloudflare pessoal. Anexos ainda precisam de conexão direta (são grandes demais para o relay).',
  ...
  'chat.projectInvite.incomingTitle': 'Convite de projeto',
  ...
  'chat.searchNoMatch': 'Nenhuma mensagem encontrada',
  'chat.slashClear': 'Voltar para texto simples',
  'chat.contentType.text': 'Texto',
  'chat.contentType.code_block': 'Código',
  'chat.contentType.command': 'Comando',
  'chat.contentType.test_result': 'Resultado de teste',
  'chat.contentType.bug_report': 'Relatório de bug',
  'chat.contacts.title': 'Conversas',
  'chat.contacts.add': 'Adicionar contato de chat',
  'chat.contacts.chatOnlyNotice':
    'Um contato de chat só permite conversar com você — isso nunca dá acesso a nenhum projeto.',
  'chat.contacts.myCodeLabel': 'Seu código — envie para a outra pessoa',
  'chat.contacts.generating': 'Gerando…',
  'chat.contacts.theirCodeLabel': 'Cole o código da outra pessoa',
  'chat.contacts.pasteHere': 'Cole aqui o código que você recebeu…',
  'chat.contacts.copy': 'Copiar código',
  'pairingRequests.title': 'Solicitações de contato',
  'pairingRequests.badgeTitle': 'Solicitações de contato pendentes',
  'pairingRequests.loadFailed': 'Não foi possível carregar as solicitações pendentes.',
  'pairingRequests.empty': 'Ninguém está esperando uma decisão agora.',
  'pairingRequests.chatOnly': 'Só conversar',
  'pairingRequests.withProject': 'Compartilhar um projeto também',
  'pairingRequests.project': 'Projeto',
  'pairingRequests.decline': 'Recusar',
  'pairingRequests.confirm': 'Confirmar',
  'pairingRequests.resolveFailed': 'Não foi possível resolver essa solicitação. Tente de novo.',
  'chat.contacts.regenerate': 'Novo código',
  'chat.contacts.regenerateHint':
    'Invalida o código atual e gera um novo — quem ainda tiver o código antigo não vai mais conseguir usá-lo.',
  'chat.contacts.copied': 'Copiado!',
  'chat.contacts.verify': 'Verificar e continuar',
  'chat.contacts.verifyFailed': 'Código inválido, ou a assinatura não confere.',
  'chat.contacts.exportFailed': 'Não foi possível gerar seu código.',
  'chat.contacts.displayLabelLabel': 'Nome para esse contato',
  'chat.contacts.displayLabelPlaceholder': 'ex.: Ana',
  ...
  'tasks.loadFailed': 'Não foi possível carregar as tarefas deste projeto.',
  ...
  'tasks.deleteConfirm': 'Excluir esta tarefa? Não é possível desfazer.',
  'tasks.category': 'Categoria',
  'tasks.noCategory': 'Sem categoria',
  'tasks.addCategory': 'Adicionar categoria',
  'tasks.newCategoryPlaceholder': 'Nome da categoria…',
  ...
  'tasks.projectsHeader': 'Projetos',
  'tasks.commentSend': 'Enviar',
  ...
  'mesh.deviceUnnamed': 'Dispositivo sem nome',
  'mesh.deviceFingerprint': 'Identificação do dispositivo',
  'mesh.deviceCopyId': 'Copiar ID do dispositivo',
  ...
  'mesh.securityLoadFailed': 'Estado de segurança indisponível',
  'mesh.oauthNotConfigured': 'O login do Google precisa de um ID de cliente OAuth para desktop',
  'mesh.oauthFailed': 'Não foi possível concluir o login do Google',
  'mesh.authenticating': 'Conectando…',
  'mesh.configureGoogle': 'Configurar login do Google',
  'mesh.googleClientId': 'ID do cliente OAuth para desktop',
  'mesh.googleClientIdHint': 'Cole o ID público. Nunca cole um segredo do cliente aqui.',
  'mesh.googleClientIdInvalid':
    'Isso não parece um ID de cliente Desktop (formato esperado: 123...apps.googleusercontent.com).',
  'mesh.googleClientSecret': 'Segredo do cliente OAuth (só para Desktop)',
  'mesh.googleClientSecretHint':
    'O tipo Desktop do Google ainda valida isso mesmo usando PKCE. Só é necessário se o login falhar com "client_secret is missing" — deixe vazio caso contrário.',
  'mesh.saveConfiguration': 'Salvar configuração',
  'mesh.editGoogleConfiguration': 'Editar',
  'mesh.disconnectAccount': 'Desconectar',
  'mesh.cloudflareWorker': 'Worker Cloudflare',
  'mesh.cloudflareStatusFailed': 'Não foi possível ler o status da conexão.',
  'mesh.cloudflareNotConfigured': 'Ainda não configurado',
  'mesh.cloudflareOnline': 'Conectado · retransmitindo ao vivo',
  'mesh.cloudflareConnecting': 'Conectando…',
  'mesh.cloudflareOffline': 'Configurado, mas desconectado',
  'mesh.cloudflareWorking': 'Processando…',
  'mesh.cloudflareConnect': 'Conectar',
  'mesh.cloudflareDisconnect': 'Desconectar',
  'mesh.cloudflareSetUp': 'Instalar e configurar',
  'mesh.cloudflareNotLoggedIn': 'Instalado, sem conta Cloudflare conectada',
  'mesh.cloudflareConnectAccount': 'Conectar conta Cloudflare',
  'mesh.cloudflareCancel': 'Cancelar',
  'mesh.cloudflareLoggingIn': 'Abrindo login do Cloudflare…',
  'mesh.cloudflareReadyToDeploy': 'Conectado — falta só publicar',
  'mesh.cloudflareContinueSetup': 'Continuar configuração',
  'mesh.cloudflareExplain':
    'Para compartilhar projetos ou conversar com pessoas fora deste dispositivo, você precisa instalar e configurar seu próprio Worker Cloudflare pessoal (gratuito). Nada é compartilhado até isso ser configurado.',
  'mesh.googleSetupExplainIntro':
    'Você vai precisar de um ID de cliente OAuth para Desktop, emitido pelo Google. É uma configuração feita só uma vez:',
  'mesh.googleSetupExplainStep1': 'Abra o Google Cloud Console e crie (ou escolha) um projeto.',
  'mesh.googleSetupExplainStep2':
    'Configure a tela de consentimento OAuth (nome do app, e-mail de suporte).',
  'mesh.googleSetupExplainStep3':
    'Em Credenciais, crie um ID de cliente OAuth do tipo "Aplicativo para computador".',
  'mesh.googleSetupExplainStep4': 'Copie o ID do cliente e cole na próxima tela.',
  'mesh.googleSetupProceed': 'Abrir Google Cloud Console',
  'mesh.googleSetupReopenPage': 'Reabrir Google Cloud Console',
  'mesh.connectedAccount': 'Conectado como {name}',
  'mesh.deviceTrust.pending': 'Verificação do dispositivo pendente',
  'mesh.deviceTrust.trusted': 'Dispositivo confiável',
  'mesh.deviceTrust.revoked': 'Dispositivo revogado',
  'mesh.accessCenter': 'Central de acesso',
  'mesh.pendingInvitations': 'Convites pendentes',
  'mesh.activeGrants': 'Permissões ativas',
  'mesh.deviceRename': 'Renomear este dispositivo',
  'mesh.deviceSaveName': 'Salvar nome',
  'mesh.deviceCancel': 'Cancelar',
  'mesh.deviceApprove': 'Aprovar dispositivo',
  'mesh.deviceReject': 'Rejeitar dispositivo',
  'mesh.deviceRevoke': 'Revogar dispositivo',
  'mesh.deviceRemove': 'Remover dispositivo',
  'mesh.deviceActionFailed': 'Não foi possível atualizar o dispositivo',
  'mesh.inviteUnavailableHint': 'Aprove este dispositivo e selecione um projeto antes de convidar',
  'mesh.invitationState.created': 'Pendente',
  'mesh.invitationState.redeemed': 'Resgatado',
  'mesh.invitationState.expired': 'Expirado',
  ...
  'mesh.permissionPreset': 'Permissões',
  ...
  'vault.editFolders': 'Editar pastas',
  'vault.editFoldersSave': 'Salvar pastas',
  'vault.editFoldersCancel': 'Cancelar',
  'vault.editFoldersFailed': 'Não foi possível atualizar as pastas compartilhadas.',
  'vault.folderScopePicker.loading': 'Escaneando pastas do projeto...',
  'vault.folderScopePicker.error': 'Não foi possível listar as pastas do projeto.',
  'vault.folderScopePicker.empty': 'Esse projeto ainda não tem subpastas.',
  'vault.p2pTransferNotice':
    'O acesso por pasta já é salvo corretamente aqui, mas a transferência de arquivos ponto-a-ponto ainda não existe — hoje só o chat trafega entre os dispositivos, então isso ainda não move nem bloqueia nenhum arquivo.',
  'mesh.permission.read': 'visualizar',
  'mesh.permission.write': 'editar',
  'mesh.permission.export': 'exportar',
  'mesh.permission.delete': 'excluir',
  'mesh.permission.invite': 'convidar outras pessoas',
  'mesh.permission.admin': 'administrar',
  'mesh.permission.upload': 'enviar arquivos',
  'mesh.permission.manage': 'gerenciar',
  'mesh.folderScopes': 'Pastas para compartilhar',
  'mesh.folderScopesMode.whole': 'Projeto inteiro',
  'mesh.folderScopesMode.specific': 'Pastas específicas',
  'mesh.folderScopesHint':
    'Escolha exatamente quais pastas essa pessoa poderá acessar — nada fora da seleção será compartilhado com ela.',
  'mesh.folderScopesNoneSelected': 'Selecione ao menos uma pasta, ou volte para "Projeto inteiro".',
  'mesh.invitationExpiry': 'Expira em',
  'mesh.invitationExpiry.1h': '1 hora',
  'mesh.invitationExpiry.24h': '24 horas',
  'mesh.invitationExpiry.7d': '7 dias',
  'mesh.inviteFailed': 'Não foi possível criar o convite',
  'mesh.confirmSensitiveInvite': 'Confirmar permissões sensíveis',
  'mesh.sendInvitation': 'Enviar convite',
  ...
  'prefs.categoryChatsProjects': 'Chats & Projetos',
  'prefs.categoryChatsProjectsDesc': 'Biografia e uso de armazenamento por projeto/contato.',
  'prefs.chatsProjects.storageTitle': 'Uso de armazenamento',
  'prefs.chatsProjects.storageDesc':
  ...
  'prefs.chatsProjects.clearCategory': 'Apagar {category}',
  'prefs.chatsProjects.unknownProject': 'Projeto sem nome',
  'prefs.chatsProjects.unknownContact': 'Contato desconhecido',
  'prefs.chatsProjects.empty': 'Nenhum anexo armazenado ainda.',
  'prefs.chatsProjects.error': 'Não foi possível carregar o uso de armazenamento — tente de novo.',
  ...
  'prefs.translationClearFailed': 'Não foi possível remover a chave.',
  ...
  'git.graph.detail.diffFailed': 'Não foi possível carregar o diff deste arquivo.',
  'git.graph.detail.diffEmpty': 'Sem diff textual (binário ou só mudança de modo).',
  ...
  'collaboration.settingsDescription':
    'Escolha como o Alethe encontra seus outros dispositivos na internet para trocar convites e montar uma conexão direta entre eles. Seus arquivos, tarefas e mensagens nunca passam por esse serviço — ele só ajuda os dispositivos a se encontrarem.',
  'collaboration.mode.local_only.title': 'Somente local',
  'collaboration.mode.local_only.description':
    'O Alethe nunca entra em contato com nenhum serviço externo. Você ainda consegue trabalhar localmente, mas não vai conseguir convidar nem descobrir dispositivos pela internet.',
  'collaboration.mode.advanced_custom.title': 'Meu próprio Worker Cloudflare',
  'collaboration.mode.advanced_custom.description':
    'O Alethe não tem servidor compartilhado — não existe um lugar central que consiga ver metadados de todo mundo. Cada pessoa que quiser colaboração online publica seu próprio Worker Cloudflare gratuito (guiado abaixo); ele só retransmite os seus próprios convites e conexões.',
  'collaboration.customEndpoint': 'Endereço do seu servidor (URL)',
  'collaboration.workerAddress': 'Seu Worker',
  ...
  'collaboration.cloudflareDeploy.installNode': 'Instalar Node.js automaticamente',
  'collaboration.cloudflareDeploy.downloadNode': 'Baixar Node.js',
  'collaboration.cloudflareDeploy.step.idle': 'Ocioso',
  'collaboration.cloudflareDeploy.step.preparing': 'Preparando',
  'collaboration.cloudflareDeploy.step.installing': 'Instalando dependências',
  'collaboration.cloudflareDeploy.step.login': 'Login na Cloudflare',
  'collaboration.cloudflareDeploy.step.secret': 'Configurando segredo',
  'collaboration.cloudflareDeploy.step.deploying': 'Publicando',
  'collaboration.cloudflareDeploy.step.success': 'Publicado',
  'collaboration.cloudflareDeploy.success': 'Worker publicado em',
  'collaboration.cloudflareDeploy.failed':
    'A publicação falhou — confira o log acima pra ver o que o Wrangler reportou.',
  ...
  'collaboration.cloudflareDeploy.alreadyPublished': 'Worker já publicado em',
  'collaboration.cloudflareDeploy.redeploy': 'Republicar',
  ...
  'collaboration.cloudflareDeploy.cancel': 'Cancelar',
  ...
  'collaboration.access.kind.device_pending_approval': 'Novo dispositivo aguardando aprovação',
  'collaboration.access.kind.invitation_redeemed': 'Convite resgatado',
  'collaboration.access.kind.sync_conflict': 'Conflito de sincronização detectado',
  'collaboration.access.kind.task_assigned': 'Tarefa atribuída a você',
  'collaboration.access.kind.chat_mention': 'Você foi mencionado no chat',
  'collaboration.access.kind.transfer_failure': 'Transferência de arquivo falhou na verificação',
  'collaboration.access.kind.pairing_request_pending': 'Alguém quer se conectar com você',
  'collaboration.notification.pairingRequestTitle': 'Alguém quer se conectar com você',
  'collaboration.notification.pairingRequestBody':
    'Abra o Alethe para decidir se quer só conversar ou também compartilhar um projeto.',
  'collaboration.notification.devicePendingApprovalTitle': 'Novo dispositivo aguardando aprovação',
  'collaboration.notification.devicePendingApprovalBody':
    'Abra o Alethe para revisar e aprovar o novo dispositivo.',
  'collaboration.notification.invitationRedeemedTitle': 'Convite resgatado',
  'collaboration.notification.invitationRedeemedBody': 'Abra o Alethe para revisar o novo acesso.',
  'collaboration.notification.syncConflictTitle': 'Conflito de sincronização detectado',
  'collaboration.notification.syncConflictBody':
    'Abra o Alethe para resolver a mudança conflitante.',
  'collaboration.notification.taskAssignedTitle': 'Tarefa atribuída a você',
  'collaboration.notification.taskAssignedBody': 'Abra o Alethe para revisar a tarefa atribuída.',
  'collaboration.notification.chatMentionTitle': 'Você foi mencionado no chat',
  'collaboration.notification.chatMentionBody': 'Abra o Alethe para ler a mensagem.',
  'collaboration.notification.transferFailureTitle':
    'Transferência de arquivo falhou na verificação',
  'collaboration.notification.transferFailureBody':
    'Abra o Alethe para revisar a transferência e tentar novamente.',
