...
export const ptBR: Record<MessageKey, string> = {
  ...
  'mesh.folderScopes': 'Pastas compartilhadas',
  'mesh.folderScopesHint':
    'Por padrão toda pasta é compartilhada. Clique numa pasta para bloqueá-la — o convidado nunca verá ela nem o conteúdo dela.',
  'mesh.folderScopesError': 'Não foi possível listar as pastas do projeto.',
  'mesh.folderScopesEmpty': 'Esse projeto ainda não tem subpastas.',
  'mesh.folderScopeIncluded': 'Compartilhada',
  'mesh.folderScopeBlocked': 'Bloqueada',
