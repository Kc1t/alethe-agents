...
export const ptBR: Record<MessageKey, string> = {
  ...
  'prefs.customAgentIconFileHint': 'Arquivo .ico quadrado de até 512KB. Guardado nos dados do app, nunca como caminho absoluto.',
  ...
  'prefs.customAgentIconUrlHint': 'Somente link https de imagem terminado em .png, .jpg ou .jpeg. Imagens remotas carregam devagar e sem referrer.',
  ...
  'prefs.customAgentErrorIconFileInvalid': 'Esse arquivo não é um .ico válido. Escolha um arquivo exportado como ícone.',
