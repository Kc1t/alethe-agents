export const en = {
  ...
  'mesh.redeemPlaceholder': 'Paste an invitation link',
  ...
  'mesh.permissionPreset.viewOnly': 'View only (read)',
  'mesh.permissionPreset.reviewer': 'Reviewer (read, export)',
  'mesh.permissionPreset.collaborator': 'Collaborator (read, write)',
