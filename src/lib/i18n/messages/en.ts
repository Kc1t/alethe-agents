export const en = {
  ...
  'collaborationView.tasksTab': 'Tasks',
  'collaborationView.vaultTab': 'Vault & Folders',
  'collaborationView.noProject': 'Open or select a project to use collaboration.',
  'collaborationView.comingSoon': 'Coming soon.',
  'chat.channelTitle': 'Project channel',
  'chat.empty': 'No messages yet — say hello.',
  'chat.loadFailed': 'Could not load or send messages.',
  'chat.connectionState.local': 'Local only',
  ...
  'chat.syncNotice.p2p': 'Connected directly to the other device — messages deliver instantly.',
  'chat.syncNotice.relay':
    "No direct connection yet — messages deliver through your personal Cloudflare Worker instead. Attachments still need a direct connection (they're too large for the relay).",
  ...
  'chat.projectInvite.incomingTitle': 'Project invite',
  ...
  'chat.searchNoMatch': 'No messages found',
  'chat.slashClear': 'Back to plain text',
  'chat.contentType.text': 'Text',
  'chat.contentType.code_block': 'Code',
  'chat.contentType.command': 'Command',
  'chat.contentType.test_result': 'Test result',
  'chat.contentType.bug_report': 'Bug report',
  'chat.contacts.title': 'Conversations',
  'chat.contacts.add': 'Add chat contact',
  'chat.contacts.chatOnlyNotice':
    'A chat contact can only talk with you — this never grants access to any project.',
  'chat.contacts.myCodeLabel': 'Your code — send it to the other person',
  'chat.contacts.generating': 'Generating…',
  'chat.contacts.theirCodeLabel': "Paste the other person's code",
  'chat.contacts.pasteHere': 'Paste the code you received here…',
  'chat.contacts.copy': 'Copy code',
  'pairingRequests.title': 'Contact requests',
  'pairingRequests.badgeTitle': 'Pending contact requests',
  'pairingRequests.loadFailed': 'Could not load pending requests.',
  'pairingRequests.empty': 'Nobody is waiting on a decision right now.',
  'pairingRequests.chatOnly': 'Just chat',
  'pairingRequests.withProject': 'Share a project too',
  'pairingRequests.project': 'Project',
  'pairingRequests.decline': 'Decline',
  'pairingRequests.confirm': 'Confirm',
  'pairingRequests.resolveFailed': 'Could not resolve this request. Try again.',
  'chat.contacts.regenerate': 'New code',
  'chat.contacts.regenerateHint':
    'Invalidate the current code and generate a new one — anyone who still has the old code will no longer be able to use it.',
  'chat.contacts.copied': 'Copied!',
  'chat.contacts.verify': 'Verify and continue',
  'chat.contacts.verifyFailed': 'Invalid code, or the signature does not match.',
  'chat.contacts.exportFailed': 'Could not generate your code.',
  'chat.contacts.displayLabelLabel': 'Name for this contact',
  ...
  'tasks.loadFailed': 'Could not load tasks for this project.',
  ...
  'tasks.newCategoryPlaceholder': 'Category name…',
  ...
  'tasks.projectsHeader': 'Projects',
  'tasks.commentSend': 'Send',
  ...
  'mesh.deviceUnnamed': 'Unnamed device',
  'mesh.deviceFingerprint': 'Device fingerprint',
  'mesh.deviceCopyId': 'Copy device ID',
  ...
  'mesh.securityLoadFailed': 'Security state unavailable',
  'mesh.oauthNotConfigured': 'Google login needs an OAuth desktop client ID',
  'mesh.oauthFailed': 'Google login could not be completed',
  'mesh.authenticating': 'Connecting…',
  'mesh.configureGoogle': 'Configure Google login',
  'mesh.googleClientId': 'OAuth desktop client ID',
  'mesh.googleClientIdHint': 'Paste the public client ID. Never paste a client secret here.',
  'mesh.googleClientIdInvalid':
    'This does not look like a Desktop client ID (expected format: 123...apps.googleusercontent.com).',
  'mesh.googleClientSecret': 'OAuth client secret (Desktop apps only)',
  'mesh.googleClientSecretHint':
    'Google\'s Desktop client type still validates this even with PKCE. Only required if sign-in fails with "client_secret is missing" — leave empty otherwise.',
  'mesh.saveConfiguration': 'Save configuration',
  'mesh.editGoogleConfiguration': 'Edit',
  'mesh.disconnectAccount': 'Disconnect',
  'mesh.cloudflareWorker': 'Cloudflare Worker',
  'mesh.cloudflareStatusFailed': 'Could not read the connection status.',
  'mesh.cloudflareNotConfigured': 'Not set up yet',
  'mesh.cloudflareOnline': 'Connected · relaying live',
  'mesh.cloudflareConnecting': 'Connecting…',
  'mesh.cloudflareOffline': 'Set up, but disconnected',
  'mesh.cloudflareWorking': 'Working…',
  'mesh.cloudflareConnect': 'Connect',
  'mesh.cloudflareDisconnect': 'Disconnect',
  'mesh.cloudflareSetUp': 'Install and set up',
  'mesh.cloudflareNotLoggedIn': 'Installed, not connected to Cloudflare',
  'mesh.cloudflareConnectAccount': 'Connect Cloudflare account',
  'mesh.cloudflareCancel': 'Cancel',
  'mesh.cloudflareLoggingIn': 'Opening Cloudflare login…',
  'mesh.cloudflareReadyToDeploy': 'Connected — one step left to deploy',
  'mesh.cloudflareContinueSetup': 'Continue setup',
  'mesh.cloudflareExplain':
    "To share projects or chat with people outside this device, you need to install and set up your own personal Cloudflare Worker (free). Nothing is shared until it's set up.",
  'mesh.googleSetupExplainIntro':
    "You'll need a Google-issued Desktop OAuth client ID. This is a one-time setup:",
  'mesh.googleSetupExplainStep1': 'Open Google Cloud Console and create (or pick) a project.',
  'mesh.googleSetupExplainStep2': 'Configure the OAuth consent screen (app name, support email).',
  'mesh.googleSetupExplainStep3':
    'Under Credentials, create an OAuth client ID of type "Desktop app".',
  'mesh.googleSetupExplainStep4': 'Copy the client ID and paste it on the next screen.',
  'mesh.googleSetupProceed': 'Open Google Cloud Console',
  'mesh.googleSetupReopenPage': 'Reopen Google Cloud Console',
  'mesh.connectedAccount': 'Connected as {name}',
  'mesh.deviceTrust.pending': 'Pending device verification',
  'mesh.deviceTrust.trusted': 'Trusted device',
  'mesh.deviceTrust.revoked': 'Revoked device',
  'mesh.accessCenter': 'Access center',
  'mesh.pendingInvitations': 'Pending invites',
  'mesh.activeGrants': 'Active grants',
  'mesh.deviceRename': 'Rename this device',
  'mesh.deviceSaveName': 'Save name',
  'mesh.deviceCancel': 'Cancel',
  'mesh.deviceApprove': 'Approve device',
  'mesh.deviceReject': 'Reject device',
  'mesh.deviceRevoke': 'Revoke device',
  'mesh.deviceRemove': 'Remove device',
  'mesh.deviceActionFailed': 'Could not update the device',
  'mesh.inviteUnavailableHint': 'Approve this device and select a project before inviting',
  'mesh.invitationState.created': 'Pending',
  'mesh.invitationState.redeemed': 'Redeemed',
  'mesh.invitationState.expired': 'Expired',
  ...
  'mesh.permissionPreset': 'Permissions',
  ...
  'vault.editFolders': 'Edit folders',
  'vault.editFoldersSave': 'Save folders',
  'vault.editFoldersCancel': 'Cancel',
  'vault.editFoldersFailed': 'Could not update the shared folders.',
  'vault.folderScopePicker.loading': 'Scanning project folders...',
  'vault.folderScopePicker.error': 'Could not list the project folders.',
  'vault.folderScopePicker.empty': 'This project has no subfolders yet.',
  'vault.p2pTransferNotice':
    'Folder access is saved here correctly, but peer-to-peer file transfer itself is not built yet — only chat travels between devices today, so this does not move or block any files yet.',
  'mesh.permission.read': 'view',
  'mesh.permission.write': 'edit',
  'mesh.permission.export': 'export',
  'mesh.permission.delete': 'delete',
  'mesh.permission.invite': 'invite others',
  'mesh.permission.admin': 'administer',
  'mesh.permission.upload': 'upload',
  'mesh.permission.manage': 'manage',
  'mesh.folderScopes': 'Folders to share',
  'mesh.folderScopesMode.whole': 'Whole project',
  'mesh.folderScopesMode.specific': 'Specific folders',
  'mesh.folderScopesHint':
    'Pick exactly which folders this person can access — nothing outside the selection will ever be shared with them.',
  'mesh.folderScopesNoneSelected': 'Select at least one folder, or switch back to "Whole project".',
  'mesh.invitationExpiry': 'Expires in',
  'mesh.invitationExpiry.1h': '1 hour',
  'mesh.invitationExpiry.24h': '24 hours',
  'mesh.invitationExpiry.7d': '7 days',
  'mesh.inviteFailed': 'The invitation could not be created',
  'mesh.confirmSensitiveInvite': 'Confirm sensitive permissions',
  'mesh.sendInvitation': 'Send invitation',
  ...
  'prefs.categoryChatsProjects': 'Chats & Projects',
  'prefs.categoryChatsProjectsDesc': 'Bio and per-project/contact storage usage.',
  'prefs.chatsProjects.storageTitle': 'Storage usage',
  ...
  'prefs.chatsProjects.clearCategory': 'Delete {category}',
  'prefs.chatsProjects.unknownProject': 'Unnamed project',
  'prefs.chatsProjects.unknownContact': 'Unknown contact',
  'prefs.chatsProjects.empty': 'No attachments stored yet.',
  'prefs.chatsProjects.error': 'Could not load storage usage — try again.',
  ...
  'prefs.translationClearFailed': 'Could not remove the key.',
  ...
  'git.graph.detail.diffLoading': 'Loading diff…',
  'git.graph.detail.diffFailed': 'Could not load this file’s diff.',
  'git.graph.detail.diffEmpty': 'No textual diff (binary or mode change only).',
  ...
  'collaboration.settingsDescription':
    'Choose how Alethe finds your other devices on the internet to exchange invitations and set up a direct connection between them. Your files, tasks, and messages are never sent through this service — it only helps devices find each other.',
  'collaboration.mode.local_only.title': 'Local only',
  'collaboration.mode.local_only.description':
    "Alethe never contacts any external service. You can still work locally, but you won't be able to invite or discover devices over the internet.",
  'collaboration.mode.advanced_custom.title': 'My own Cloudflare Worker',
  'collaboration.mode.advanced_custom.description':
    'Alethe has no shared server — there is no central place that could see metadata across every user. Each person who wants online collaboration deploys their own free Cloudflare Worker (guided below); it only ever relays your own invitations and connections.',
  'collaboration.customEndpoint': 'Address of your server (URL)',
  'collaboration.workerAddress': 'Your Worker',
  ...
  'collaboration.privacyHidden':
    'It cannot see: your Google login, private keys, file names or paths, project content, tasks, or chat messages — all of that stays end-to-end encrypted.',
  'collaboration.ownWorkerRequired':
    "There's no Alethe-run shared server: sharing a project or chatting with people outside this device requires deploying your own free personal Cloudflare Worker below.",
  'collaboration.cloudflareDeploy.title': 'Deploy your own Cloudflare worker',
  'collaboration.cloudflareDeploy.description':
    'Alethe runs npm and Wrangler on this machine to deploy a personal rendezvous worker to your own free Cloudflare account. Wrangler opens your browser for login and keeps its own token on this device — Alethe never sees or stores your Cloudflare credentials.',
  'collaboration.cloudflareDeploy.installNode': 'Install Node.js automatically',
  'collaboration.cloudflareDeploy.downloadNode': 'Download Node.js',
  'collaboration.cloudflareDeploy.step.idle': 'Idle',
  'collaboration.cloudflareDeploy.step.preparing': 'Preparing',
  'collaboration.cloudflareDeploy.step.installing': 'Installing dependencies',
  'collaboration.cloudflareDeploy.step.login': 'Cloudflare login',
  'collaboration.cloudflareDeploy.step.secret': 'Configuring secret',
  'collaboration.cloudflareDeploy.step.deploying': 'Deploying',
  'collaboration.cloudflareDeploy.step.success': 'Deployed',
  'collaboration.cloudflareDeploy.success': 'Worker deployed at',
  'collaboration.cloudflareDeploy.failed':
    'The deploy failed — check the log above for what Wrangler reported.',
  ...
  'collaboration.cloudflareDeploy.alreadyPublished': 'Worker already published at',
  'collaboration.cloudflareDeploy.redeploy': 'Republish',
  ...
  'collaboration.cloudflareDeploy.cancel': 'Cancel',
  ...
  'collaboration.access.kind.device_pending_approval': 'New device awaiting approval',
  'collaboration.access.kind.invitation_redeemed': 'Invitation redeemed',
  'collaboration.access.kind.sync_conflict': 'Sync conflict detected',
  'collaboration.access.kind.task_assigned': 'Task assigned to you',
  'collaboration.access.kind.chat_mention': 'You were mentioned in chat',
  'collaboration.access.kind.transfer_failure': 'File transfer failed verification',
  'collaboration.access.kind.pairing_request_pending': 'Someone wants to connect with you',
  'collaboration.notification.pairingRequestTitle': 'Someone wants to connect with you',
  'collaboration.notification.pairingRequestBody':
    'Open Alethe to decide whether to just chat or also share a project.',
  'collaboration.notification.devicePendingApprovalTitle': 'New device awaiting approval',
  'collaboration.notification.devicePendingApprovalBody':
    'Open Alethe to review and approve the new device.',
  'collaboration.notification.invitationRedeemedTitle': 'Invitation redeemed',
  'collaboration.notification.invitationRedeemedBody': 'Open Alethe to review the new access.',
  'collaboration.notification.syncConflictTitle': 'Sync conflict detected',
  'collaboration.notification.syncConflictBody': 'Open Alethe to resolve the conflicting change.',
  'collaboration.notification.taskAssignedTitle': 'Task assigned to you',
  'collaboration.notification.taskAssignedBody': 'Open Alethe to review the assigned task.',
  'collaboration.notification.chatMentionTitle': 'You were mentioned in chat',
  'collaboration.notification.chatMentionBody': 'Open Alethe to read the message.',
  'collaboration.notification.transferFailureTitle': 'File transfer failed verification',
  'collaboration.notification.transferFailureBody': 'Open Alethe to review the transfer and retry.',
