export const en = {
  ...
  'mesh.folderScopes': 'Shared folders',
  'mesh.folderScopesHint':
    'By default every folder is shared. Click a folder to block it — the recipient will never see it or its contents.',
  'mesh.folderScopesError': 'Could not list the project folders.',
  'mesh.folderScopesEmpty': 'This project has no subfolders yet.',
  'mesh.folderScopeIncluded': 'Shared',
  'mesh.folderScopeBlocked': 'Blocked',
