...
export const en = {
  ...
  'whatsNew.v150.note1': 'Onboarding no longer hangs while detecting installed CLIs; each check now has a time limit.',
  'whatsNew.v150.note2': 'Account and profile switching now completes reliably without restarting the app, including parked terminal recovery.',
  'whatsNew.v150.note3': 'New "Erase all data (fresh install)" action resets every profile, project and setting after you export a backup.',
  'whatsNew.v150.note4': 'Profile exports now include all profile data, including Todos, history, preferences, tokens and terminal scrollback.',
  'whatsNew.v150.note5': 'LAN remote control lets you browse agent chats, watch terminal output and send messages from an authenticated mobile web view.',
  'whatsNew.v150.note6': 'Choose a native desktop icon independently from the app theme, including every Alethe theme and both gradient variants.',
  'whatsNew.v150.note7': 'Project dropdowns now stay inside the viewport, truncate long paths and support Escape consistently.',
  'whatsNew.v150.note8': 'Codex resume prevents two terminals from claiming the same conversation and recovers cleanly from active-writer errors.',
  ...
  'widget.spotifyConnectHint': "show what you're listening to",
  ...
  'crud.groupIconHint':
    'Use a URL or upload a local image. Replaces the colored bullet in the sidebar. Leave empty to use the color.',
  'crud.groupColorPreview':
    'Preview: the color paints the container borders and the sidebar bullet.',
  ...
  'ui.titlebar.closeTodoSidebar': 'Close Todo sidebar',
  'ui.titlebar.openTodoSidebar': 'Open Todo sidebar',
  ...
  'resource.suspended.title': 'Idle runtime parked',
  'resource.suspended.body': 'Its scrollback and session were preserved. Open it to resume.',
