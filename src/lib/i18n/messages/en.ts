export const en = {
  ...
  'prefs.multiagentPluginsTitle': 'Plugin manager',
  'prefs.multiagentPluginsDesc': 'View and install orchestrator plugins and custom tools.',
  'prefs.multiagentPluginInstallLabel': 'Install plugin (JSON manifest)',
  'prefs.multiagentPluginInstallPlaceholder': 'Paste the plugin manifest JSON here...',
  'prefs.multiagentPluginInstallButton': 'Install plugin',
  'prefs.multiagentPluginInstallInvalid': 'Invalid manifest. Fill in name, version, and kind.',
  'prefs.multiagentPluginInstallSuccess': 'Plugin installed successfully.',
  'prefs.multiagentPluginInstallError': 'Failed to install plugin: {error}',
  'prefs.multiagentPluginUninstall': 'Uninstall',
  'prefs.multiagentPluginUninstallConfirm':
    'Are you sure you want to uninstall the plugin "{name}"?',
  'prefs.multiagentPluginUninstallSuccess': 'Plugin uninstalled.',
  'prefs.multiagentPluginUninstallError': 'Failed to uninstall plugin: {error}',
  'prefs.multiagentPluginKind': 'Type: {kind}',
  'prefs.multiagentPluginBundled': 'Bundled',
  'prefs.multiagentPluginEnabled': 'Enabled',
  'prefs.multiagentPluginError': 'Failed to activate: {error}',
  'prefs.multiagentNoPlugins': 'No plugins installed yet.',
