export const en = {
  'projectGrid.default': 'Default',
  'projectGrid.create': 'Create grid',
  'projectGrid.rename': 'Rename grid',
  'projectGrid.delete': 'Delete grid',
  'projectGrid.move': 'Move to grid',
  'projectGrid.name': 'Grid name',
  'projectGrid.destination': 'Destination grid',
  'projectGrid.invalidName': 'Enter a unique, non-empty name. The default grid name is reserved.',
  'projectGrid.keepTerminals': 'Move to Default and remove grid',
  'projectGrid.deleteTerminals': 'Delete grid and terminals',
  'projectGrid.deleteDescription':
    'Delete “{name}”? Move its {count} terminal(s) to Default to keep their sessions, or delete them all and end their sessions.',
  'projectGrid.deleteFailed':
    'Could not finish deleting the grid. Remaining terminals are preserved. Try again.',
  ...
  'onboarding.profileTitle': 'What should we call you?',
  'onboarding.profileSubtitle':
    'Just so the app can greet you. You can change it whenever you want.',
  'onboarding.name': 'Name',
  'onboarding.namePlaceholder': 'Your name',
  'onboarding.photoTitle': 'Photo',
  'onboarding.photoChange': 'change',
  'onboarding.photoHint': 'Click the avatar to choose a photo.',
  'onboarding.orImportFrom': 'or import from',
  'onboarding.githubImport': 'Use my GitHub avatar',
  'onboarding.githubHandlePlaceholder': 'GitHub username',
  'onboarding.githubUse': 'Use',
  'onboarding.githubSignIn': 'Sign in with GitHub — optional',
  'onboarding.githubSignedIn': 'Signed in as {login} — your preferences will sync to the cloud.',
  'onboarding.githubFailed': 'GitHub sign-in failed — you can try again or continue without it.',
  'onboarding.agentsTitle': 'Which AIs do you use?',
  'onboarding.agentsFound': 'Tap to turn one on or off. Found {count} on this machine.',
  ...
  'onboarding.featuresSearch': 'search module',
  'onboarding.featuresClearSearch': 'Clear search',
  'onboarding.featuresGroupWorkspace': 'in the workspace',
  'onboarding.featuresGroupAgents': 'agents',
  'onboarding.featuresGroupOthers': 'others',
  'onboarding.featuresExperimental': 'experimental',
  'onboarding.featuresShowMore': 'Show {count} more modules',
  'onboarding.featuresNoMatch': 'No module with that name.',
  'onboarding.featuresEnabledOf': '{enabled} of {total} enabled · change later in Preferences',
  'onboarding.goToApp': 'Go to the app',
  'onboarding.footerNote': 'The setup is local and can be changed later in Preferences.',

  /* ---- home setup walkthrough ---- */
  'walkthrough.title': 'Finish the setup',
  'walkthrough.progress': '{done} of {total} · takes 2 minutes',
  'walkthrough.hide': 'hide',
  'walkthrough.footer': 'It disappears on its own once every item is done.',
  'walkthrough.done': 'Done',
  'walkthrough.projectTitle': 'Open your first project',
  'walkthrough.projectDesc': 'A folder becomes a project with terminals and history.',
  'walkthrough.appearanceTitle': 'Make it yours',
  'walkthrough.appearanceDesc': 'Theme and interface density.',
  'walkthrough.appearanceFooter': 'Applies instantly · also in Preferences.',
  ...
  'menu.addOrchestrator': 'Add orchestration',
  ...
  'remote.tutorialTitle': 'How to use it',
  'remote.tutorialDesc': 'Off by default. Nobody can connect until you do all of this yourself.',
  'remote.tutorialStep1':
    'Right-click a terminal and choose "Show on remote devices" for anything you want visible remotely — every terminal is private by default.',
  'remote.tutorialStep2':
    'Turn on Remote control below, then tap "Open pairing window" to show a QR code.',
  'remote.tutorialStep3':
    'On your phone, open a browser on the same Wi-Fi network and scan the QR code to pair — the code expires in 2 minutes.',
  'remote.tutorialStep4':
    'From the paired device you can view live output and, unless Read-only is on, send one message at a time to a shared terminal.',
  'remote.tutorialStep5':
    'To reach Alethe from outside your Wi-Fi, install Tailscale on this PC and your phone, then set Reach to Tailscale below — see docs/REMOTE_CONTROL_TAILSCALE.md for the full guide.',
  ...
  'remote.topbarEnabledIdle': 'Remote control on',
  ...
  'remote.securityNoteTailscale':
    'Turning it off disconnects every paired device. Traffic is encrypted by WireGuard end to end over your tailnet, so it stays private even off your home network.',
  ...
  'question.sendUncertain': 'Delivery could not be confirmed. Check the question before retrying.',
  ...
  'remote.autoDisabledToastTitle': 'Remote control turned itself off',
  'remote.autoDisabledToastBody':
    'No device connected for a while, so Alethe closed the listener automatically.',
  'remote.startFailedToastTitle': "Remote control couldn't start",
  'remote.startFailedToastBody':
    'Alethe was unable to open the listener — check the selected reach mode and try again.',
  'remote.startupNote':
    'Remote control never starts on its own. Alethe only opens the LAN listener while this setting is on.',
  'remote.reachTitle': 'Reach',
  'remote.reachDesc': 'Choose which network paired devices can reach this listener from.',
  'remote.reachLan': 'Local network',
  'remote.reachTailscale': 'Tailscale',
  'remote.reachTailscaleHint':
    'Devices on your tailnet can pair even off your Wi-Fi. Traffic is encrypted by WireGuard before it leaves this machine. Applies the next time you turn remote control on. For an extra layer of protection, restrict which tailnet devices can reach this port with a Tailscale ACL — see docs/REMOTE_CONTROL_TAILSCALE.md.',
  'remote.reachTailscaleUnavailable':
    'Tailscale was not detected on this machine. Install it and sign in to enable this option.',
  'remote.reachTailscaleDownloadUrl': 'https://tailscale.com/download',
  'remote.reachTailscaleCopyLink': 'Copy download link',
  'remote.reachTailscaleLinkCopied': 'Copied',
  ...
  'remote.readOnlyHint':
    'When on, paired devices can watch terminal output but can never send a message.',
  'remote.readOnlyOn': 'View only',
  'remote.readOnlyOff': 'Allow messages',
  'remote.shellInput': 'Shell terminals',
  'remote.shellInputHint':
    'Whether paired devices can send commands to raw shell tabs, not just agent chats.',
  ...
  'remote.settingsSecurityNoteTailscale':
    'Per-device sessions, input sanitization, connection limits, and restrictive response headers are always enabled. Traffic is also encrypted end to end by WireGuard while reach mode is set to Tailscale.',
  ...
  'remote.sessionExpiryHint':
    'How long a paired device stays signed in before it has to scan a new QR code.',
  ...
  'prefs.viewPlacement': 'Panel location',
  'prefs.viewPlacementDesc': 'Choose which sidebar each plugin panel opens in.',
  'prefs.viewPlacementEmpty': 'No plugin adds a sidebar panel right now.',
  'prefs.viewPlacementLeft': 'Left sidebar',
  'prefs.viewPlacementRight': 'Right sidebar',
  ...
  /* ---- optional features ---- */
  'features.todos.keywords': 'todo tasks checklist reminders',
  'features.browser.keywords': 'browser web websites pane preview',
  'features.graphify.keywords': 'graph code dependencies map',
  'features.mcp.keywords': 'mcp skills servers tools context protocol',
  'features.playwright.keywords': 'playwright browser automation e2e testing',
  'features.orchestrator.keywords': 'orchestration workers parallel codex claude swarm',
  'features.aiMemory.keywords': 'memory recall long term context shared',
  'features.gsdSync.keywords': 'gsd sync opencode child session planning watcher',
  ...
  'features.playwright.description':
    'Points the Playwright MCP server at a browser — shared with Alethe or a dedicated one of its own, picked below.',
  'features.playwright.browserMode.label': 'Browser',
  'features.playwright.browserMode.shared': 'Shared',
  'features.playwright.browserMode.dedicated': 'Dedicated',
  'features.playwright.browserMode.sharedHint':
    'Attaches to the browser Alethe already owns (headless, visible only inside a Browser Pane). Shared with every other agent using it at the same time.',
  'features.playwright.browserMode.dedicatedHint':
    'Launches its own separate browser, outside Alethe, independent of the shared one and of any other agent.',
  'features.playwright.headless.label': 'Run the dedicated browser headless (no visible window)',
  ...
  'features.gsdSync.description':
    'Tracks the isolated child sessions OpenCode runs while planning, and shows their activity live. Only appears in projects with an OpenCode terminal.',
  ...
  'prefs.pluginsInstalledTitle': 'Installed',
  'prefs.pluginsInstalledDesc':
    'Everything Alethe has loaded. Turning one off removes what it contributes right away.',
  'prefs.pluginsEmpty': 'No plugins installed yet.',
  'prefs.pluginsVersion': 'v{version}',
  'prefs.pluginsSourceBundled': 'Bundled',
  'prefs.pluginsSourceLocal': 'Local',
  'prefs.pluginsKindUi': 'Interface',
  'prefs.pluginsKindTheme': 'Theme',
  'prefs.pluginsKindAgentType': 'Agent type',
  'prefs.pluginsKindSkill': 'Skill',
  'prefs.pluginsKindValidationPipeline': 'Validation pipeline',
  'prefs.pluginsStatusEnabled': 'Enabled',
  'prefs.pluginsStatusDisabled': 'Disabled',
  'prefs.pluginsToggleLabel': 'Enable {name}',
  'prefs.pluginsActivationError': 'Failed to activate: {error}',
  'prefs.pluginsCapabilitiesShow': 'What it can do ({count})',
  'prefs.pluginsCapabilitiesNone': 'It declares nothing beyond running.',
  'prefs.pluginsCapabilityTheme': 'Add themes',
  'prefs.pluginsCapabilityPane': 'Add workspace panes',
  'prefs.pluginsCapabilitySidebarTab': 'Add a sidebar tab',
  ...
  'prefs.pluginsCatalogDesc':
    'Plugins published by their authors. Each listing is pinned to a checksum, so what installs is what was reviewed.',
  ...
  'prefs.pluginsCatalogInstall': 'Install',
  'prefs.pluginsCatalogUpdate': 'Update',
  'prefs.pluginsCatalogUpdateAvailable': 'Update available (you have {version})',
  'prefs.pluginsCatalogReinstall': 'Reinstall',
  'prefs.pluginsCatalogInstalling': 'Installing…',
  'prefs.pluginsCatalogInstallDone': '{name} installed',
  'prefs.pluginsCatalogInstallDoneBody':
    'It is switched off. Turn it on above once you are happy with what it asks for.',
  'prefs.pluginsCatalogInstallError': 'That plugin could not be installed.',
  'prefs.pluginsCatalogPinned': 'Pinned to a checksum',
  'prefs.pluginsCatalogSource': 'View source',
  'prefs.pluginsCatalogOpenError': 'That link could not be opened.',
  'prefs.pluginsCatalogHint':
    'A listed plugin is third-party code that runs with the same reach as the app. Being listed is not an audit — read the source before turning one on.',
  'prefs.pluginsUninstall': 'Uninstall',
  'prefs.pluginsUninstallTitle': 'Uninstall {name}?',
  'prefs.pluginsUninstallBody':
    'Its folder is removed from disk and everything it contributes disappears right away.',
  'prefs.pluginsUninstallConfirm': 'Uninstall plugin',
  'prefs.pluginsUninstallSuccess': 'Plugin uninstalled.',
  'prefs.pluginsUninstallError': 'Failed to uninstall plugin: {error}',
  'prefs.pluginsTrustTitle': 'Enable {name}?',
  'prefs.pluginsTrustBody':
    'This plugin came from your own disk. Nobody has reviewed it, and it runs with the same access as Alethe itself — treat it like any other program you choose to run.',
  'prefs.pluginsTrustCapabilities': 'It is asking to:',
  'prefs.pluginsTrustConfirm': 'Enable plugin',
  'prefs.pluginsInstallTitle': 'Install from a folder',
  'prefs.pluginsInstallDesc':
    'Put the plugin folder in the plugins directory, then register it by pasting its manifest.',
  'prefs.pluginsFolderLabel': 'Plugins folder',
  'prefs.pluginsRescan': 'Rescan folder',
  'prefs.pluginsOpenFolder': 'Open plugins folder',
  'prefs.pluginsOpenFolderError': 'Could not open the plugins folder.',
  'prefs.pluginsImport': 'Import plugin…',
  'prefs.pluginsImportHint':
    'Pick the plugin folder. It is copied in and stays off until you turn it on.',
  'prefs.pluginsImportSuccess': '{name} imported. Turn it on below to run it.',
  'prefs.pluginsImportError': 'Import failed: {error}',
  'prefs.pluginsManifestAdvanced': 'Advanced: paste a manifest',
  'prefs.pluginsManifestLabel': 'Plugin manifest (JSON)',
  'prefs.pluginsManifestPlaceholder': 'Paste the plugin manifest JSON here...',
  'prefs.pluginsInstallButton': 'Install plugin',
  'prefs.pluginsInstallInvalid': 'Invalid manifest. It needs id, name, version and kind.',
  'prefs.pluginsInstallSuccess': 'Plugin installed.',
  'prefs.pluginsInstallError': 'Failed to install plugin: {error}',
  ...
  'prefs.customAgentIconFileHint': 'Square .ico up to 512KB. Stored in app data, never as an absolute path.',
  ...
  'prefs.customAgentIconUrlHint': 'Https image link ending in .png, .jpg or .jpeg. Remote images load lazily with no referrer.',
  ...
  'prefs.customAgentErrorIconFileInvalid': 'That file is not a valid .ico. Pick an .ico file exported as an icon.',
  ...
  'widget.resetCreditInfo':
    '{n} reset credit(s) can reset an eligible Codex limit. This does not erase chats or settings.',
  'widget.resetCreditHeading': 'Usage limit resets',
  'widget.resetCreditDefaultTitle': 'Complete reset (weekly + 5h)',
  'widget.resetCreditDefaultDescription': 'Reset an eligible Codex usage limit.',
  'widget.resetCreditExpires': 'Expires {date}',
  'widget.useResetCredit': 'Use reset credit',
  'widget.resetCreditWorking': 'Using…',
  'widget.resetCreditFailedTitle': 'Could not use reset credit',
  ...
  'term.newTerminalTitle': 'New session',
  'term.newPlannerTitle': 'New planner',
  ...
  'term.browse': 'Browse',
  'term.advancedOptions': 'Advanced',
  'term.advancedHint': 'permissions, runtime, folder path',
  'term.gridLabel': 'Grid',
  'term.gridUngrouped': 'Ungrouped',
  'term.optional': 'optional',
  'term.openAs': 'Open as',
  'term.openAsTerminal': 'Terminal',
  'term.openAsTerminalSide': 'tabs and splits',
  'term.openAsTerminalDesc': 'Tabs and splits, one agent per pane.',
  'term.openAsOrchestration': 'Orchestration',
  'term.openAsOrchestrationSide': 'planner and agent canvas',
  'term.openAsOrchestrationDesc': 'One planner commanding several agents.',
  'term.agentLabel': 'Agent',
  'term.plannerLabel': 'Planner',
  'term.plannerSide': 'commands the agents',
  'term.plannerContext': 'Joins the orchestration in {project}',
  'term.folderLabel': 'Folder',
  'term.projectLabel': 'Project',
  'term.goalLabel': 'Goal',
  ...
  'ws.emptyOpenGroup': 'Open group workspace',
  'ws.emptyNewProject': 'New project',
  'ws.emptyFindJump': 'Find and jump',
  'ws.emptyOpenPanes': 'Open all panes',
  'ws.emptyNewTerminal': 'New terminal',
  'ws.emptyAddContent': 'Add content',
  ...
  'ws.paneLoadingGraph': 'Loading graph...',
  'ws.viewFailed': '{name} could not start, so this panel is unavailable.',
  'ws.paneUnavailable': 'No provider for "{kind}" panes. Its plugin may be disabled.',
  'ws.paneLoadingMarkdown': 'Loading markdown...',
  ...
  'orchestrator.queued': '{count} queued',
  'orchestrator.limit': 'limit {count}',
  'orchestrator.emptyTitle': 'No workers yet.',
  'orchestrator.emptyBody':
    'Ask an agent to delegate, and every worker Alethe starts shows up here as it runs.',
  'orchestrator.tokensTitle': 'Tokens this worker has used',
  'orchestrator.costTitle': 'Session cost reported by this worker',
  'orchestrator.noPrice': 'no price',
  ...
  'orchestrator.status.failed': 'failed',
  'orchestrator.status.cancelled': 'cancelled',
  ...
  'orchestrator.blockedTitle':
    'It stopped to ask before acting, and it holds its slot doing nothing until you answer.',
  'orchestrator.plannersLabel': 'Planners',
  'orchestrator.runsLabel': 'runs',
  'orchestrator.runCount': '{count} runs',
  'orchestrator.selectRun': 'Open this run and bring it into view',
  ...
  'orchestrator.emptyPlanner': 'This planner has not delegated any work yet.',
  'orchestrator.noWorkers': 'No workers under this planner.',
  'orchestrator.agentTitle': 'Runs on {agent}',
  'orchestrator.runFailed': '{count} failed',
  'orchestrator.runInterrupted': '{count} interrupted',
  'orchestrator.runBlocked': '{count} waiting on you',
  'orchestrator.quotaWarning': '{agent} at {pct}% (resets {resets})',
  'orchestrator.quotaWarningTitle':
    '{agent} is at {pct}% of its usage window. Consider sending new work to the other agent.',
  'orchestrator.quotaResetsNow': 'now',
  ...
  'orchestrator.zoomFitTitle': 'Fit the graph to the view',
  'orchestrator.workerCount': '{count} workers',
  'orchestrator.lane.running': 'running',
  'orchestrator.lane.queued': 'queued',
  'orchestrator.lane.interrupted': 'interrupted',
  'orchestrator.lane.failed': 'failed',
  'orchestrator.lane.finished': 'finished',
  'orchestrator.lane.blocked': 'waiting on you',
  'orchestrator.summary': 'summary',
  'orchestrator.summaryCollapse': 'Hide summary',
  'orchestrator.summaryExpand': 'Show summary',
  'orchestrator.finishedHeadline': 'of {total} workers',
  'orchestrator.percent': '{value}%',
  'orchestrator.slots': 'slots in use',
  'orchestrator.selectWorker': 'Open this worker',
  'orchestrator.planLabel': 'plan',
  'orchestrator.summaryLabel': 'last report',
  ...
  'orchestrator.answerAccept': 'Approve once',
  'orchestrator.answerAcceptTitle': 'Lets it do this one thing, and it asks again next time',
  'orchestrator.answerSession': 'Approve for the session',
  'orchestrator.answerSessionTitle': 'Stops this worker asking again for the rest of its session',
  'orchestrator.answerDecline': 'Decline',
  'orchestrator.answerDeclineTitle': 'Refuses this one thing; the worker carries on another way',
  ...
  'sync.cloud.freeDesc':
    'Sync your name, theme, UI preferences and selected plugins across devices — free with your GitHub account.',
  'sync.cloud.signIn': 'Sign in with GitHub',
  'sync.cloud.waiting': 'Waiting for authorization…',
  'sync.cloud.codeHint': 'Enter this code on GitHub:',
  'sync.cloud.openGithub': 'Open GitHub',
  'sync.cloud.connectedAs': 'Signed in as {login}',
  'sync.cloud.pushDone': 'Preferences uploaded.',
  'sync.cloud.pullDone': 'Preferences applied on this device.',
  'sync.cloud.premiumSoon': 'Full projects & stats sync — Premium, coming soon.',
  ...
  'sync.error.not_configured': 'Cloud sync is not available in this build yet.',
  'sync.error.session_expired': 'Your session expired — sign in again.',
  ...
  'router9.desc':
    'Local proxy that routes Claude Code, Codex, and OpenCode through multiple providers with automatic fallback.',
  'router9.stateOff': 'Routing off',
  'router9.stateReady': 'Ready, not running',
  'router9.stateRunning': 'Routing through {url}',
  'router9.setupIntro':
    'Nothing installed yet. Alethe can install a private, version-pinned copy for you, or use a 9router you already have on your PATH.',
  'router9.sourceLabel': 'Which install to run',
  'router9.probing': 'Checking what you already have…',
  'router9.nodeFound': 'Node {version} detected — Alethe can install 9router for you.',
  'router9.nodeMissing': 'Node.js was not found. It is required to install or run 9router.',
  'router9.needsNodeToInstall': 'Install Node.js first, then come back to install 9router.',
  'router9.sourceManaged': 'Installed by Alethe',
  'router9.sourceExternal': 'My own install',
  'router9.managedInstalled': 'Ready · {version}, in the Alethe profile folder',
  'router9.managedMissing': 'Not installed yet — Alethe can install it for you',
  'router9.externalInstalled': 'Found · {version} at {path}',
  'router9.externalMissing': 'No 9router found on your PATH',
  'router9.externalDetected':
    'You already have a 9router on your PATH. Pick "My own install" to use it instead of a second copy.',
  'router9.fallbackManaged':
    'Your own install is gone, so the copy installed by Alethe is used instead.',
  'router9.fallbackExternal':
    'The copy installed by Alethe is gone, so your own install is used instead.',
  'router9.installForMe': 'Install it for me',
  'router9.uninstallManaged': "Remove Alethe's copy",
  ...
  'router9.installIntro':
    'Installed into a private folder managed by Alethe, pinned to a known version. Your global npm packages are not touched.',
  'router9.uninstallIntro':
    'The proxy is stopped and the package is removed from the Alethe folder.',
  'router9.securityNote':
    '9router has known security advisories. Alethe never installs or updates it on its own, only routes over loopback, and never enables its remote sharing feature. Read the advisories before routing real credentials through it.',
  'router9.securityAdvisories': 'Read the security advisories',
  'router9.statusInstalled': 'Installed · {version}',
  'router9.statusNotInstalled': 'Not installed',
  'router9.statusRunning': 'running',
  'router9.statusStopped': 'stopped',
  'router9.start': 'Start',
  'router9.starting': 'Starting…',
  'router9.stop': 'Stop',
  'router9.dashboard': 'Open dashboard',
  'router9.enabled': 'Routing',
  'router9.enabledOn': 'Enabled',
  'router9.enabledOff': 'Disabled',
  'router9.autoStart': 'Start with Alethe',
  'router9.autoStartOn': 'Yes',
  'router9.autoStartOff': 'No',
  'router9.port': 'Port',
  'router9.apiKey': 'Endpoint key',
  'router9.apiKeyHint':
    'Generated in the 9router dashboard. Stored in plaintext in the profile folder, like the other local integration credentials.',
  'router9.missingKey': 'Routing is on but no endpoint key is set, so nothing is routed yet.',
  'router9.portInUse':
    'Port {port} is already taken by another process. Stop it or pick a different port.',
  'router9.pinnedMismatch':
    'The installed version differs from the one Alethe pins. Use Update to move to the pinned version.',
  'router9.runningTerminalsHint':
    'Turning routing off only affects terminals opened afterwards. Agents already running keep the address they started with — restart them to change route.',
  'router9.routeToggle': 'Route through 9router',
  'router9.routeToggleDesc': 'Point this agent at the local proxy instead of the provider.',
  'router9.alwaysRoute': 'Always route new agents',
  'router9.stoppedStart': '9router is stopped — start it',
  'router9.pillOn': 'on',
  'router9.pillOff': 'off',
  'router9.pillStart': 'Start 9router',
  'router9.pillStop': 'Stop 9router',
  'router9.onboardingTitle': 'Route around rate limits',
