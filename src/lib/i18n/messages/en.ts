export const en = {
  ...
  'browser.openInGridOption': 'Add beside terminals instead',
  'browser.openInGridOptionDescription':
    'Places the page in the project grid. Leave unchecked to open a dedicated browser tab.',
  ...
  'browser.destinationTab': 'Opens as its own tab for {project}, separate from the terminal grid.',
  'browser.destinationGrid': 'This browser will be added to the {project} grid.',
  ...
  'xterm.openInBrowserTab': 'Open in browser tab',
  'xterm.addMarkdownToGroupView': 'Add Markdown to group view',
  'xterm.openInFolder': 'Open in folder',
  'xterm.copy': 'Copy',
  'xterm.contextCopy': 'Copy',
  'xterm.contextPaste': 'Paste',
  'xterm.contextSelectAll': 'Select All',
  'xterm.contextCopyContext': 'Copy Context',
  'xterm.contextClearScreen': 'Clear Screen',
  ...
  'webPane.addressBar': 'Address bar',
  ...
  'webPane.agentOpenedAction': 'Show in browser tab',
