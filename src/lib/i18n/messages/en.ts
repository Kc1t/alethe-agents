export const en = {
  ...
  'prefs.viewPlacementDesc':
    'Choose which sidebar each plugin panel opens in.',
  ...
  'prefs.dictationHandyHint':
    'For richer dictation (open-source, more control over the model), try Handy (github.com/cjpais/Handy) alongside this — it types straight into the focused terminal, same as this built-in toggle.',
