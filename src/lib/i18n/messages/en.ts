export const en = {
  ...
  'chat.e2eBadge': 'E2E encrypted',
  'chat.empty': 'No messages yet — say hello.',
  'chat.loadFailed': 'Could not load or send messages.',
  'chat.localOnlyNotice':
    'Messages currently sync only on this device — remote delivery is not implemented yet.',
  ...
  'collaboration.recommendedBadge': 'Recommended',
  ...
  'collaboration.mode.alethe_managed.description':
    'Works out of the box using Alethe\'s official server. No setup needed — just click "Enable collaboration" below.',
  'collaboration.mode.advanced_custom.title': 'Own provider',
  'collaboration.mode.advanced_custom.description':
    'For advanced users: point Alethe at a compatible server that you host and control yourself.',
  ...
  'collaboration.noCloudflareAccount':
    "You don't need your own Cloudflare account or any technical setup to use the recommended Alethe service option.",
  ...
  'p2pTest.title': 'P2P connection test with a friend',
  'p2pTest.description':
    'Manual flow to validate a remote invitation and a direct (P2P) connection between two different accounts on different networks. Each step says what to do — coordinate the marked fields with your friend out of band (chat, etc.).',
  'p2pTest.step1': '1. Generate your pairing code and send it to your friend',
  'p2pTest.generateCode': 'Generate my code',
  'p2pTest.copy': 'Copy',
  'p2pTest.step2': '2. Paste the code your friend sent you',
  'p2pTest.pasteFriendCode': "Paste your friend's code here…",
  'p2pTest.verify': 'Verify',
  'p2pTest.friendVerified': "Friend's device verified: {device}",
  'p2pTest.step3': '3. Connect to Cloudflare (the same Worker both of you configured)',
  'p2pTest.connect': 'Connect',
  'p2pTest.connected': 'Connected',
  'p2pTest.step4': '4. Send a test invitation for the active project',
  'p2pTest.invitationIdLabel': 'Invitation ID (agree with your friend)',
  'p2pTest.sendInvite': 'Send invitation',
  'p2pTest.step5': '5. Agree on a session ID and exchange connection candidates',
  'p2pTest.sessionIdLabel': 'P2P session ID (any text, both of you type the same one)',
  'p2pTest.shareCandidate': 'Discover and send my address',
  'p2pTest.checkIncoming': 'Check Cloudflare deliveries',
  'p2pTest.myCandidate': 'My public address: {addr}',
  'p2pTest.friendCandidate': "Friend's address received: {addr}",
  'p2pTest.step6':
    '6. Try the direct connection — only one side clicks "Initiator", the other "Responder"',
  'p2pTest.connectAsInitiator': 'Connect as initiator',
  'p2pTest.connectAsResponder': 'Connect as responder',
  'p2pTest.initiatorHint':
    'Agree out of band on who clicks which — both sides attempting the same role at once deadlocks the handshake.',
  'p2pTest.p2pSuccess': 'Direct P2P connection established with device {device}!',
  'p2pTest.logEmpty': 'No action yet.',
