...
| SYNC-INV-003 | Every installation has a distinct asymmetric device identity; account login never silently trusts a device. | Registration, cloned-profile, key-rotation, and revoked-device tests. |
